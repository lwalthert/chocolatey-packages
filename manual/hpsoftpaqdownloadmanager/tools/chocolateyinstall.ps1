...
$packageName= 'hpsoftpaqdownloadmanager' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://ftp.hp.com/pub/softpaq/sp74501-75000/sp74705.exe' 
...
$packageArgs = @{
  ...
  #MSI
  silentArgs    = '/s /v"/qn /norestart /l*v `"$env:TEMP\chocolatey\$($packageName)\$($packageName).MsiInstall.log`""' # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
  ...
  softwareName  = 'hpsoftpaqdownloadmanager*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = 'DB10F3AC9505D92EE47E599228403162'
